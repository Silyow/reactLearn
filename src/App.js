    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="blockBox">
          ...
          <div className="block">
            <p className="blockTitle">状态提升(例:输入水的温度控制沸腾状态)</p>
            <div className="blockComponent">
              <Calculator />
            </div>
          </div>
...
//状态提升，(即多个组件反映同一个状态变化，将state提示为父级的state控制)
//例子水的沸腾点
const scaleNames = {
  c: "Celsius",
  f: "Fahrenheit",
...
class TemperatureInput extends React.Component {
  ...
  render() {
    ...
    return (
      <fieldset>
        <legend>改变水的{scaleNames[scale]}度数:</legend>
        <input value={temperature} onChange={this.changeValue} />
      </fieldset>
    );
  }
}
...
class Calculator extends React.Component {
  ...
  render() {
    ...
    const celsius =
      scale == "c" ? temperature : tryConvert(temperature, toFahrenheit);
    const fahrenheit =
      scale == "f" ? temperature : tryConvert(temperature, toCelsius);
    return (
      <div>
        <TemperatureInput
          scale="c"
